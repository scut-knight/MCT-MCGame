...
#define TextureKey_five @"five2"
#define TextureKey_four @"four2"
#define TextureKey_night @"night2"
#define TextureKey_one @"one2"
#define TextureKey_seven @"seven2"
#define TextureKey_six @"six2"
#define TextureKey_step @"step2"
#define TextureKey_three @"three2"
#define TextureKey_time @"time2"
#define TextureKey_two @"two2"
...
#define Face_BlueKEY @"blueface"
#define Face_OrangeKEY @"orangeface"
#define Face_RedKEY @"redface"
